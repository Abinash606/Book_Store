                  ...
                  <tr key={book._id} className='h-8'>
                    ...
                    <td className='border border-slate-700 rounded-md text-center'>
                      <div className='flex justify-center gap-x-4'>
                        ...
                        <Link to={`/book/edit/${book._id}`}> <AiOutlineEdit className=' text-2xl text-yellow-600' />
                        </Link>
                        <Link to={`book/delete/${book._id}`}> <MdOutlineDelete className='text-2xl text-red-600' />
                        </Link>
                      </div>
                    </td>
                  </tr>
